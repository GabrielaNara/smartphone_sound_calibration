...
for location in locations:  
    ...
    for sensor_number in fix_sensors:
        ...
        cols = [col for col in merged_df.columns if col.startswith("samsungA7")]
        merged_df[cols] = merged_df[cols] + 0.5
    
        # Save the file
        os.makedirs(path_+'/outputs/time_series_by_sensor', exist_ok=True)
